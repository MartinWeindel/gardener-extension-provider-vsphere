...
func AddToManagerWithOptions(mgr manager.Manager, opts AddOptions) error {
	return controlplane.Add(mgr, controlplane.AddArgs{
		Actuator: genericactuator.NewActuator(vsphere.Name,
			getControlPlaneSecrets(opts.UseTokenRequestor), getShootAccessSecrets(opts.UseTokenRequestor), getLegacySecretNamesToCleanup(opts.UseTokenRequestor), nil, nil, nil,
...
func getControlPlaneSecrets(useTokenRequestor bool) secrets.Interface {
